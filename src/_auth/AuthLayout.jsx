...
import dashboard from "../assets/one.jpeg";
import monicardLogo from "../assets/monicardLogo.png";
...
<div className='absolute inset-0 bg-black/60'>
      ...
      <div className="hidden lg:relative lg:block lg:p-8 text-[#aeb3dd]">
        <a className="block text-white" href="#">
          ...
          <img src={monicardLogo} alt=""  className="h-8 sm:h-10 bg-white rounded-full" />
        </a>
...
<img src={monicardLogo} alt=""  className="h-8 sm:h-10 rounded-full" />
          </a>
