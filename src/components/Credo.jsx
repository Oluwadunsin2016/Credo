...
const Credo = () => {
  return (
    ...
    <h1 className="text-2xl md:text-5xl font-bold leading-8">You + <span className="text-blue-500">Credo</span></h1>
    </div>

    <div className="animate__animated animate__fadeInRight">
    <p className="text-lg text-[#a8a9aa]">Credo is committed to empowering your business to make and receive smarter payments in a highly secure environment.</p>
    </div>
