    ...
    <div className="flex flex-col gap-4">
      <div>
        <Input
          ...
          type="text"
          label="Full Name"
          {...register("personal_information.full_name", {
        ...
        {errors?.personal_information?.full_name && (
          <p className="text-red-500 text-sm mt-1">
            {errors?.personal_information?.full_name.message}
          </p>
        )}
      </div>
      ...
      <div>
        <Input
          ...
          type="text"
          label="Home Address"
          {...register("personal_information.home_address", {
            required: "Home address is required",
          })}
          fullWidth
        />
        {errors?.personal_information?.home_address && (
          <p className="text-red-500 text-sm mt-1">
            {errors?.personal_information?.home_address.message}
          </p>
        )}
      </div>
      ...
      <div>
        <Input
          ...
          type="email"
          label="Email Address"
          {...register("personal_information.email_address", {
          ...
          fullWidth
        />
        {errors?.personal_information?.email_address && (
          <p className="text-red-500 text-sm mt-1">
            {errors?.personal_information?.email_address.message}
          </p>
        )}
      </div>
